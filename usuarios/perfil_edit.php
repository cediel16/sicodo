...
sesiones::logged_in();
if (!sesiones::is_has_permission('usuarios.perfil.editar')) {
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="form-horizontal row-fluid" >
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input class="span6" type="text" id="cedula" name="cedula" maxlength="8" value="<?php echo (var_post('cedula')=='') ? $usuario['cedula'] : var_post('cedula') ?>" />
                            <?php echo $msj_cedula ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span6" type="text" id="nombre" name="nombre" value="<?php echo (var_post('nombre')=='') ? $usuario['nombre'] : var_post('nombre') ?>" />
                            <?php echo $msj_nombre ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="span6" type="text" id="email" name="email" value="<?php echo (var_post('email')=='') ? $usuario['email'] : var_post('email') ?>" />
                            <?php echo $msj_email ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="span6" id="rol" name="rol">
                                <?php
                                $rol=(var_post('rol')=='') ? $usuario['rol_fkey'] : var_post('rol');
